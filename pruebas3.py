...
class Menu_registradora(app.MainApp, tk.Toplevel):
	def __init__(self, parent, *args, **kargs):
		...
		self.menu_frame = tk.Frame(self.paned_window, bg= self.color_menu, width=200)
	...
	def create_menu(self):
		user_info = tk.Label(self.menu_frame, text="Alexander Pierce", bg= self.color_menu, fg='white', font=('Arial', 16))
	...
	def show_dashboard_v4(self, args = ""):
		...
		self.textNombre = ctk.CTkEntry(self.frameDatosPersonales, placeholder_text="Ingresar Nombres", font=("", 15, "bold"))
		...
		self.textFechaNacimiento = DateEntry(self.frameDatosPersonales, font=("", 11, "bold"))
		...
		self.radiobutton_hombre = ctk.CTkRadioButton(self.frameDatosPersonales, text="Hombre", variable=self.radio_sexo, text_color="#005C78", font=("", 14, "bold"), value=1)
		self.radiobutton_hombre.grid(row=3, column=1, padx=0, pady=10, sticky="w")

		self.radiobutton_mujer = ctk.CTkRadioButton(self.frameDatosPersonales, text="Mujer", variable=self.radio_sexo, text_color="#005C78", font=("", 14, "bold"), value=2)
		...
		self.textApellido = ctk.CTkEntry(self.frameDatosPersonales, placeholder_text="Ingresar Apellidos", font=("", 15, "bold"))
		...
		self.textTelefono1 = ctk.CTkEntry(self.frameDatosPersonales, validate='key', validatecommand=vcmd, placeholder_text="Ingresar Teléfono 1", font=("", 15, "bold"))
		...
		self.option_menu = ctk.CTkOptionMenu(self.frameDatosPersonales, variable=self.opcion_seleccionada,
											 values=self.estado_empleado_option_menu)
		...
		self.textFechaContrato = DateEntry(self.frameDatosPersonales, font=("", 11, "bold"))
		...
		self.textEmail = ctk.CTkEntry(self.frameDatosPersonales, placeholder_text="Ingresar el correo electrónico (Opci.)", fg_color="white", text_color="black", font=("", 15, "bold"))
		...
		self.textDireccion = ctk.CTkEntry(self.frameDatosPersonales, placeholder_text="Ingresar dirección domiciliaria (Opci.)", fg_color="white", text_color="black", font=("", 15, "bold"))
		...
		self.botones = (
			self.botonRegistrar, self.botonEditarDatos 
		)

		nPosicionBoton = 0
		for boton in self.botones:
			boton.configure(font=("", 19))
			boton.grid(column=1, row=nPosicionBoton, pady=10, padx=10, sticky="ew")
			nPosicionBoton += 1
	...
	def show_dashboard_v5(self):
		self.clear_content()
		ctk.CTkLabel(self.content_frame, text = "hola configuracion").pack()
